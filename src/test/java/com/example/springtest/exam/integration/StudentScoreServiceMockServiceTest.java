...
public class StudentScoreServiceMockServiceTest {
    ...
    void saveScoreMockTest() {
        ...
        Assertions.assertEquals(capturedStudentScore.getStudentName(), expectStudentScore.getStudentName());
        ...
        Assertions.assertEquals(capturedStudentScore.getEnglishScore(), expectStudentScore.getEnglishScore());
